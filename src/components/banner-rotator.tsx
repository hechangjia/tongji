...
function BannerRotatorInner({ banner }: { banner: Exclude<ShellBannerData, null> }) {
  ...
  return (
    <section className="maika-banner-surface overflow-hidden rounded-[24px] border border-cyan-300/30 px-5 py-5 text-white shadow-[0_20px_50px_rgba(8,47,73,0.22)]">
